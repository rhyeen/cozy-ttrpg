import { CampaignFactory, CharacterFactory, FriendConnectionFactory, PlayFactory, PrivatePlayEventFactory, PublicPlayEventFactory, StorageFileFactory, UserFactory } from '@rhyeen/cozy-ttrpg-shared';
...
export const storageFileFactory = new StorageFileFactory();